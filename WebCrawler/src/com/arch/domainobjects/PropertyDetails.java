...
public class PropertyDetails {
	...
	/**
	 * @return the similarLinks
	 */
	public String getSimilarLinks() {
		return similarLinks;
	}
	/**
	 * @param similarLinks the similarLinks to set
	 */
	public void setSimilarLinks(String similarLinks) {
		this.similarLinks = similarLinks;
	}
	...
	/**
	 * @return the rentOrSale
	 */
	public String getRentOrSale() {
		return rentOrSale;
	}
	/**
	 * @param rentOrSale the rentOrSale to set
	 */
